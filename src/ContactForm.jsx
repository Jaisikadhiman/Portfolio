...
const ContactForm = () => {
  ...
  return (
          ...
          <ul className="contact-list">
            ...
            <li className="list-item">
              ...
              <span className="contact-text gmail">
                <a href="mailto:jaisikadhiman446@gmail.com" title="Send me an email">
    ...
    <li>
      <a href="https://www.instagram.com/?hl=en" target="_blank" className="contact-icon" rel="noreferrer">
