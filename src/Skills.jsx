    ...
    >
      ...
      <div className="contents">
        <div className="flex">
          ...
          <SemiDonutChart percentage={55} fill="#03B0FD" txt="Bootstrap" />
        </div>
        <div className="flex">
          <SemiDonutChart percentage={80} fill="#03B0FD" txt="JavaScript" />
          <SemiDonutChart percentage={75} fill="#03B0FD" txt="React JS" />
          <SemiDonutChart percentage={75} fill="#03B0FD" txt="Redux Toolkit" />
        </div>
        <div className="flex">
          <SemiDonutChart percentage={80} fill="#03B0FD" txt="Node Js" />
          <SemiDonutChart percentage={60} fill="#03B0FD" txt="Express Js" />
          <SemiDonutChart percentage={60} fill="#03B0FD" txt="MongoDB" />
        </div>
        <div className="flex">
        <SemiDonutChart percentage={80} fill="#03B0FD" txt="API Integration" />
        </div>
      </div>
